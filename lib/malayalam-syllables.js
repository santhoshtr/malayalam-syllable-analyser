malayalamSyllableParser = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c13 = /^[\u0D4E]/,
        peg$c14 = { type: "class", value: "[\u0D4E]", description: "[\u0D4E]" },
        peg$c15 = /^[\u0D7B\u0D7C\u0D7D\u0D7E\u0D7F\u0D7A\u0D54\u0D55\u0D56]/,
        peg$c16 = { type: "class", value: "[\u0D7B\u0D7C\u0D7D\u0D7E\u0D7F\u0D7A\u0D54\u0D55\u0D56]", description: "[\u0D7B\u0D7C\u0D7D\u0D7E\u0D7F\u0D7A\u0D54\u0D55\u0D56]" },
        peg$c17 = /^[\u200C]/,
        peg$c18 = { type: "class", value: "[\\u200C]", description: "[\\u200C]" },
        peg$c19 = /^[\u200D]/,
        peg$c20 = { type: "class", value: "[\\u200D]", description: "[\\u200D]" },
        peg$c21 = function(c1, x) { return [c1, x].join( '' ); },
        peg$c22 = function(c1x, c2) {
        	return [c1x, c2].join( '' );
        },
        peg$c23 = function(v, h, a, x) {
        	if ( x && a ) {
    ...
    function peg$parseHalfConsonant() {
      var s0, s1, s2;
